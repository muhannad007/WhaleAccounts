  ...
  return (
    <div>
      {!isLoading && chatData && Object.keys(chatData).length > 0 ? (
        <div>
          <TextAnimation
            detail={{ text: "Most recent Youtube Channels promoting [" }}
          />
          ...
          {chatData?.recent_partners &&
            chatData?.recent_partners.map((partner, idx) => {
              return (
                <a
                  key={idx}
                  href={`https://youtube.com/channel/${partner?.channelId}`}
                ...
                >
                  ...
                  <img
                    ...
                    width={20}
                    height={20}
                    className="rounded-full mr-1 fade-in"
                  />
                  <TextAnimation
                    detail={{
                      text: `${partner?.title?.substring(0, 30)}`,
                      style: "#06FBC6",
                    }}
                    className=""
                  />
                  ...
                  <TextAnimation
                    detail={{
                      text: `${diffTimeStamp(partner?.final_datetime)}`,
                      style: "#06FBC6",
                    }}
                  />
                  ...
                  <TextAnimation
                    detail={{
                      text: `${formatShorterNumber(partner?.subscriberCount)}`,
                      style: "#06FBC6",
                    }}
                  />
          ...
          <TextAnimation
            detail={{
              text: `${chatData?.first_datetime?.substring(0, 10)}`,
              style: "#06FBC6",
            }}
          />
          <TextAnimation detail={{ text: "] [" }} />
          ...
          <TextAnimation
            detail={{
              text: `${commaNumber(chatData?.youtube_channels)}`,
              style: "#06FBC6",
            }}
          />
          <TextAnimation
            detail={{ text: "] Youtube Channels with a total of [" }}
          />
          <TextAnimation
            detail={{
              text: `${formatShorterNumber(chatData?.followers)}`,
              style: "#06FBC6",
            }}
          />
          ...
          <TextAnimation
            detail={{
              text: `${commaNumber(chatData?.youtube_videos)}`,
              style: "#06FBC6",
            }}
          />
          ...
          <TextAnimation
            detail={{
              text: `${formatShorterNumber(chatData?.viewCounts)}`,
              style: "#06FBC6",
            }}
          />
          ...
          {chatData?.top_videos && (
            <div>
              <TextAnimation
                detail={{ text: "The most viewed video promoting [" }}
              />
              <TextAnimation detail={{ text: `${text}`, style: "#06FBC6" }} />
              <TextAnimation detail={{ text: "] is [" }} />
              <a
                href={`https://youtube.com/watch?v=${chatData?.top_videos[0]?.videoId}`}
                rel="noopener noreferrer"
                target="_blank"
                className="flex items-center"
              >
                <TextAnimation
                  detail={{
                    text: `${chatData?.top_videos[0]?.title}`,
                    style: "#06FBC6",
                  }}
                />
              </a>
          ...
          {chatData?.recent_videos && (
            <div>
              <TextAnimation
                detail={{ text: "The most recent video promoting [" }}
              />
              <TextAnimation detail={{ text: `${text}`, style: "#06FBC6" }} />
              <TextAnimation detail={{ text: "] is [" }} />
              <a
                href={`https://youtube.com/watch?v=${chatData?.recent_videos[0]?.videoId}`}
                rel="noopener noreferrer"
                target="_blank"
                className="flex items-center"
              >
                <TextAnimation
                  detail={{
                    text: `${chatData?.recent_videos[0]?.title}`,
                    style: "#06FBC6",
                  }}
                />
              </a>
          ...
          <TextAnimation
            detail={{
              text: "Please send me any other website to analyze [...]",
            }}
          />
        </div>
      ) : (
