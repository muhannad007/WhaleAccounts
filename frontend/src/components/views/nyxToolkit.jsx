...
const tabsData = [
  ...
  },
  {
    ...
    content:
      "After enduring countless crypto scams, Nyx became a trusted leader in the field. Learning from setbacks, Nyx now adeptly identifies deception while emphasizing the importance of community and team integrity. With Nyx's guidance, investors can navigate the crypto world with confidence.",
  },
];
            ...
            {tabsData.map((tab, idx) => {
              return (
                <div className="flex flex-col justify-between" key={idx}>
                  ...
                  {activeTabIndex === idx ? (
                    <div className="mask h-1 bg-gradient-to-r from-[#5AB0FF] to-[#01FFC2]"></div>
                  ) : (
