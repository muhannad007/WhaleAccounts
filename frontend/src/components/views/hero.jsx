...
function Hero() {
  ...
  const updateText = () => {
    setDisplayText(<NyxChat text={inputText} />);
  };
          ...
          <div className="mt-0 md:mt-[2px]">
            <div className="xl:relative xl:border-[0.5px] border-[#747474aa]">
              <div className="grid grid-cols-1 xl:grid-cols-2 z-[1]">
                <div
                  className="text-white pt-[32px] ps-[6px] sm:ps-[16px]"
                  style={{ zIndex: "1" }}
                >
                  ...
                  <p className="font-light text-[#EEEEEE] my-[11px] sm:my-[15px] md:my-[20px] lg:my-[26px] font-[RobotoMonoLight] xl:text-[20px] lg:text-[18px] md:text-[18px] sm:text-[16px] text-[14px] leading-tight tracking-widest pe-[6px]">
                    ...
                    real-time project data, and navigate the crypto landscape
                ...
                >
                      ...
                      >
                        ...
                        <div className="2xl:h-[450px] w-full pb-3">
                          <div className="p-3 min-h-[200px] overflow-auto max-h-[502px]">
                            <div className="flex">
                              <img
                                src="/assets/images/icon/nxybot.png"
                                className="mr-[10px] w-[20px] h-[12px] sm:w-[24px] sm:h-[12px] md:w-[28px] md:h-[15px] my-auto"
                              />
                              <span className="font-regular text-[14px] sm:text-[16px]md:text-[18px] font-[RobotoMono]">
                                Nyx Cipher
                              </span>
                            </div>
                            <div
                              className="pl-[29px] sm:pl-[34px] md:pl-[37px] text-[#EEEEEE]"
                              id="messageBox"
                            >
                              {displayText}
                            </div>
                  ...
                  <div className="absolute right-[-2px] top-[88px] xl:hidden z-[2]">
                    <img
                      src="../assets/images/bg_images/chatBox/responsive/top_right.png"
                      alt=""
                    />
                  </div>
                  <div className="absolute bottom-[-2px] left-[-3px] xl:hidden">
                    <img
                      src="../assets/images/bg_images/chatBox/responsive/bottom_left.png"
                      alt=""
                    />
                  </div>
                  <div className="absolute bottom-[-2px] left-[-3px] xl:hidden">
                    <img
                      src="../assets/images/bg_images/chatBox/responsive/bottom.png"
                      alt=""
                    />
                  </div>
                  <div
                    className="absolute px-[3px] xl:hidden"
                    style={{
                      zIndex: "-1",
                  ...
                  >
                    <div
                      className="backdrop-blur-md bg-opacity-60 w-full h-full bg-[black]"
                      style={{}}
                    ></div>
                  </div>
                </div>
                ...
                <div
                  className="text-white px-[10px] pb-[5px]"
                  style={{ zIndex: "1" }}
                >
                  <div className="flex justify-center lg:justify-start gap-[24px] pt-[24px] xl:pt-0">
                    <Button detail={{ value: "Whitepaper", icon: true }} />
                  ...
                  <p className="pt-[14px] xl:pt-[85px] pb-[46px] leading-tight tracking-widest text-[#EEEEEE] text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-light font-[RobotoMonoLight]">
                    Let Nyx be your guide, deciphering community insights to
              ...
              <div className="absolute hidden xl:block right-[-3px] top-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/top_right_top.png"
                  alt=""
                />
              </div>
              <div className="absolute hidden xl:block right-[-3px] top-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/top_right_right.png"
                  alt=""
                />
              </div>
              <div className="absolute hidden xl:block left-[-3px] bottom-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/bottom_left.png"
                  alt=""
                />
              </div>
              <div className="absolute hidden xl:block right-[-3px] bottom-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/bottom_right_right.png"
                  alt=""
                />
              </div>
              <div className="absolute hidden xl:block right-[-3px] bottom-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/bottom_right_bottom.png"
                  alt=""
                />
              </div>
              <div className="absolute hidden xl:block left-[-3px] top-[-3px] z-[1]">
                <img
                  src="../assets/images/bg_images/chatBox/top_left.png"
                  alt=""
                />
              </div>
              ...
              >
                <div className="backdrop-blur-md bg-opacity-60 w-full h-full bg-[black]"></div>
              </div>
            </div>
          </div>
